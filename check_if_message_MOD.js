module.exports = {
    ...
    action: function(cache) {
        ...
        switch(info) {
            case 0:
                result = Boolean(msg.pinnable);
                break;
            case 1:
                result = Boolean(msg.pinned);
                break;
            case 2:
                result = Boolean(msg.deletable);
                break;
            case 3:
                result = Boolean(msg.deleted);
                break;
            case 4:
                result = Boolean(msg.tts);
                break;
            case 5:
                result = Boolean(msg.system);
                break;
            case 6:
                result = Boolean(msg.mentions.everyone);
                break;
            default:
